...
(function () {
  ...
  function renderSummary(el, e, data) {
    el.innerHTML = '<div class="sv-summary">' + esc(e.summary) + '</div>' + updLine(data);
  }
  ...
  function renderTable(el, e, data) {
    ...
    var f = useM ? toM : toCm;
    if (e.mode === 'type') {
      h += '<tr><th>タイプ</th><th>幅<br>' + unit + '</th><th>奥<br>' + unit + '</th><th>高<br>' + unit + '</th><th>月額<br>賃料</th><th>NO,</th><th>空室<br>状況</th></tr>';
      ...
      h += '<tr><th>NO,</th><th>帖</th><th>幅<br>' + unit + '</th><th>奥<br>' + unit + '</th><th>高<br>' + unit + '</th><th>月額<br>賃料</th><th>空室<br>状況</th></tr>';
      e.rows.forEach(function (r) {
